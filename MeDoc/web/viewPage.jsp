                        ...
                        <div id="container">
                            <div id="body">
                                ...
                                <div class="userSection">
                                    <div class="messages user-message">Hi can I get an appointment from doctor?
                                        <form action="responsePage.jsp" method="POST" class="respond_button"> 
                                ...
                                <div class="botSection">
                                    <div class="messages bot-reply">
                                        Sure, we will see details about it and update you.
                                    </div>
                                    <div class="seperator"></div>
                                </div>
                                <%
